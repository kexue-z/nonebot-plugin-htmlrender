...
async def text_to_pic(
    ...
    Args:
        ...
        image_type (Literal["jpeg", "png"]): 图片类型, 默认 png
    ...
    Returns:
        bytes: 图片, 可直接发送
    """
    async with track_render("playwright.text_to_pic", backend=RenderBackend.PLAYWRIGHT):
...
async def md_to_pic(
    ...
    Returns:
        bytes: 图片, 可直接发送
    """
    async with track_render("playwright.md_to_pic", backend=RenderBackend.PLAYWRIGHT):
...
async def template_to_pic(
    ...
    Returns:
        bytes: 图片 可直接发送
    """
    async with track_render("playwright.template_to_pic", backend=RenderBackend.PLAYWRIGHT):
        if pages is None:
            pages = {
...
async def capture_element(
    ...
    Returns:
        bytes: 元素截图数据
    """
    async with track_render("playwright.capture_element", backend=RenderBackend.PLAYWRIGHT):
